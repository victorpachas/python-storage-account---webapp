...
connect_str = "DefaultEndpointsProtocol=https;AccountName=<nombrestorage>;AccountKey=<key>;EndpointSuffix=core.windows.net"
...
##Storage account User Managed identity Access
#account_url = "https://<storageaccountname>.blob.core.windows.net"
#connect_str = DefaultAzureCredential(managed_identity_client_id="<client_id>")
#if connect_str != "":
#    blob_service_client = BlobServiceClient(account_url, credential=connect_str)
